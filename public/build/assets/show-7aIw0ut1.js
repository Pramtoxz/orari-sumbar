import{j as t,L as c}from"./app-B9oIzjV1.js";import{P as m,e as d}from"./sertifikatorari-4LAfNvQM.js";import{B as x}from"./button-Bfm7zvVT.js";import{f as a}from"./format-BlyJTOGp.js";import{p as n}from"./parseISO-8c5X91YK.js";import"./createLucideIcon-CNnp-jE_.js";function g({esql:e}){const i=s=>{try{return a(n(s),"dd/MM/yyyy")}catch{return s}},l=s=>{try{return s.includes("T")?a(n(s),"HH:mm"):s}catch{return s}},r=()=>{window.print()};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
                    @font-face {
                        font-family: 'VAG';
