import{j as t,L as c}from"./app-DWMV4Bz7.js";import{P as m,e as d}from"./sertifikatorari-D_Jwap8P.js";import{B as x}from"./button-ZbZsCIY2.js";import{f as a}from"./format-BlyJTOGp.js";import{p as n}from"./parseISO-8c5X91YK.js";import"./createLucideIcon-BO-cLNwE.js";function g({esql:e}){const i=s=>{try{return a(n(s),"dd/MM/yyyy")}catch{return s}},l=s=>{try{return s.includes("T")?a(n(s),"HH:mm"):s}catch{return s}},r=()=>{window.print()};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
                    @font-face {
                        font-family: 'VAG';
