import{j as t,L as c}from"./app-kY0CTwjp.js";import{P as m,e as d}from"./sertifikatorari-Dirk2kxs.js";import{B as x}from"./button-C0SiGRSN.js";import{f as a}from"./format-BlyJTOGp.js";import{p as n}from"./parseISO-8c5X91YK.js";import"./createLucideIcon-Cd8udVIo.js";function g({esql:e}){const i=s=>{try{return a(n(s),"dd/MM/yyyy")}catch{return s}},l=s=>{try{return s.includes("T")?a(n(s),"HH:mm"):s}catch{return s}},r=()=>{window.print()};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
                    @font-face {
                        font-family: 'VAG';
