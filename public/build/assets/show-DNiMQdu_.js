import{j as t,L as c}from"./app-CUw4cQzH.js";import{P as m,e as d}from"./sertifikatorari-kMjNO8_5.js";import{B as x}from"./button-2CaqLeln.js";import{f as a}from"./format-BlyJTOGp.js";import{p as n}from"./parseISO-8c5X91YK.js";import"./createLucideIcon-DpoG8-b0.js";function g({esql:e}){const i=s=>{try{return a(n(s),"dd/MM/yyyy")}catch{return s}},l=s=>{try{return s.includes("T")?a(n(s),"HH:mm"):s}catch{return s}},r=()=>{window.print()};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
                    @font-face {
                        font-family: 'VAG';
